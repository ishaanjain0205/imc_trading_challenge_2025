...
class TradingState(object):
    ...
    def __init__(self,
        ...
        # buy and sell orders per product that bots have sent 
        self.order_depths = order_depths
        # trades the algo has done since last TradingState
        self.own_trades = own_trades
        # trades done by other algos since last TradingState
        self.market_trades = market_trades
        # positions held by algo, dict, key = product
